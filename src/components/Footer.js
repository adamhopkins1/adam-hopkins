        ...
        <div class="grid grid-cols-1 gap-8 lg:grid-cols-3">
          <div>
            ...
            <p class="mx-auto mt-6 max-w-md text-center leading-relaxed text-gray-500 sm:mx-0 sm:max-w-xs sm:text-left">
              A blog that beleives in Truth Justice and the Journalistic way. Welcome and Enjoy!
            </p>

            <ul class="mt-8 flex justify-center gap-6 sm:justify-start md:gap-8">
              <li>
                <a
                  href="https://www.facebook.com/vgchronicle/"
                  rel="noreferrer"
                  target="_blank"
              ...
              <li>
                <a
                  href="https://www.instagram.com/pushsquare/"
                  rel="noreferrer"
                  target="_blank"
                  class="text-teal-700 transition hover:text-teal-700/75"
                >
